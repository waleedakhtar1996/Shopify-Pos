...
return [
    ...
    */
    ...
    'api_init' => function ($options, $session, $request) {
        $options->setGuzzleOptions(['timeout' => 30.0, 'connect_timeout' => 15.0]);
        $ts = \Gnikyt\BasicShopifyAPI\Store\Memory::class;
        $ls = \Gnikyt\BasicShopifyAPI\Store\Memory::class;
        $sd = \Gnikyt\BasicShopifyAPI\Deferrers\Sleep::class;
        $api = new \Gnikyt\BasicShopifyAPI\BasicShopifyAPI($options, new $ts(), new $ls(), new $sd());
        if ($session !== null) {
